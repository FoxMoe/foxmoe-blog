    ...
    <div class="main-content">
      <section class="error-page fancy">
        ...
        <form method="post" class="error-search" role="search">
          ...
          <button type="submit" class="error-btn primary"><span class="material-icons" aria-hidden="true">search</span><span><?php _e('搜索'); ?></span></button>
          <a href="<?php $this->options->siteUrl(); ?>" class="error-btn ghost"><span class="material-icons" aria-hidden="true">home</span><span><?php _e('返回首页'); ?></span></a>
        </form>
